...
def DataLoadIn():
    LoadFile = pd.read_csv(
        "../sample/pecan-home2233-grid_solar-20190602.csv",
        header=0,
        names=["DateTime", "Grid Power", "Solar Power"],
    )
...
def main():
    ...
    DefinedTimeStep = 60
    [LoadFile, PVFile, WindFile, PriceFile] = MatrixOutput(
        LoadFile,
        PVFile,
        WindFile,
        PriceFile,
