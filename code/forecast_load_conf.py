class ForecastLoadConfig:
    def __init__(self):
        ...
        self.DATAID = 1222
        self.OUTPUT_FOLDER = "./output/forecast/load/30min/out48/lb20/"

        self.LOAD_MODEL = False
        self.NB_PLOT = 4
        self.OUTPUT_FOLDER = "./output/forecast/load/30min/out48/lb20/"
        self.MODEL_FILE = "./output/forecast/load/30min/out48/lb20/model.json"
        self.MODEL_FILE_H5 = "./output/forecast/load/30min/out48/lb20/model.h5"
